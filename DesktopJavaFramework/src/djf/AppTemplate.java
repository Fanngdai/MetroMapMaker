...
public abstract class AppTemplate extends Application {
	...
	AppAlertDialogSingleton messageDialog = AppAlertDialogSingleton.getSingleton();
	messageDialog.init(primaryStage);
        AppConfirmDialogSingleton yesNoDialog = AppConfirmDialogSingleton.getSingleton();
	yesNoDialog.init(primaryStage);
        AppMetroLineDialogSingleton lineDialog = AppMetroLineDialogSingleton.getSingleton();
        lineDialog.init(primaryStage);
	...
	try {
		...
		String appTitle = props.getProperty(WELCOME_TITLE);
                
                // BUILD THE BASIC APP GUI OBJECT FIRST
                // Everything will be set up but will not show at first.
		...
		buildAppComponentsHook();
            ...
            dialog.show(props.getProperty(PROPERTIES_LOAD_ERROR_TITLE), "ERROR" ,
                    props.getProperty(PROPERTIES_LOAD_ERROR_MESSAGE));
	}
    }
